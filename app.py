...
FOOD_SYNONYM_GROUPS = [
    ...
    ['牛乳', 'ぎゅうにゅう'],
    ['小松菜'],
    # ── 一括登録（2026-09-09）：個別に見つかる都度追加するのではなく、
    # 献立名によく使われる野菜・肉・魚をまとめて登録。「白身魚」「きのこ」等の
    # 総称（具体的な種類が何であってもOKなもの）は対象外（既存の除外方針を踏襲）。
    ['ほうれん草'],
    ['キャベツ'],
    ['大根'],
    ['れんこん'],
    ...
    ['鶏肉', '鶏', 'とりにく'],
    ['豚肉', '豚'],
    ['牛肉'],  # 「牛」1文字だけだと「牛乳」に誤反応するため単独では追加しない
    ['サケ'],
    ['サーモン'],
    ['サバ'],
    ['サワラ'],
    ...
    ['シシャモ'],
    ['ほっけ'],
    # 麺類（献立名に麺の種類が明記されているのに材料に無い記入漏れ対策。
    # 例：中央幼稚園様10/23「くたくたみそうどん」なのに材料にうどんが無い）
    ['うどん'],
    ['そば'],
    ['スパゲティ'],
    ['ラーメン', '中華麺'],
...
FOOD_NAME_IDIOMS = ['メロンパン', '焼きそば']  # 「焼きそば」は麺の種類がそば(蕎麦)ではなく中華麺のため除外
